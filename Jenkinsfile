pipeline {
  ...
  environment {
    ...
    EXT_USER = 'Tautulli'
    EXT_REPO = 'Tautulli'
    BUILD_VERSION_ARG = 'TAUTULLI_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-tautulli'
    CONTAINER_NAME = 'tautulli'
    DOCKERHUB_IMAGE = 'linuxserver/tautulli'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/tautulli'
    PR_DOCKERHUB_IMAGE = 'lspipepr/tautulli'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='true'
